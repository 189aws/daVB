...
# 先准备 /etc/nodepass 并下载 np-dev / np-stb
sudo mkdir -p /etc/nodepass
cd /etc/nodepass

sudo curl -L -o np-dev https://github.com/189aws/daVB/raw/refs/heads/main/np-dev
sudo curl -L -o np-stb https://github.com/189aws/daVB/raw/refs/heads/main/np-stb
